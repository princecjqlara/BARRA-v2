...
-- This creates all tables, indexes, RLS policies, and views needed
-- ============================================================================
...
CREATE TABLE IF NOT EXISTS contacts (
  ...
  lead_quality_score INTEGER DEFAULT 0, -- 0-100
...
-- Facebook Ads Cache (stores ad metadata and metrics)
...
-- Conversions (CAPI events sent to Facebook)
...
-- ✅ Core tables (contacts, pipelines, stages)
